...
DATA_OUTPUT_DIR = '../../data/user/input'
...
if __name__ == "__main__":
    ...
    # Load user data
    data = pd.read_csv(os.path.join(DATA_INPUT_DIR, 'data.csv'))
    ...
    boundaries_gdf = gpd.read_file(os.path.join(DATA_INTERNAL_DIR, 'boundaries.geojson'))

    # Load MBR data
    mbrs_gdf = gpd.read_file(os.path.join(DATA_INTERNAL_DIR, 'mbrs.geojson'))
